...
/**
 * Configuration options for the LogstashStream.
 */
...
export class LogstashStream extends EventEmitter {
  ...
  /**
   * Helper method to establish a standard TCP connection.
   *
   * @param onConnectCallback Callback invoked when the connection is successfully established.
   */
  ...
  /**
   * Helper method to establish a secure TLS connection.
   *
   * @param onConnectCallback Callback invoked when the connection is successfully established.
   */
